    ...
    insights: [
      {
        ...
        stance: "Automating processes you don't deeply understand creates brittle systems that fail unpredictably.",
      ...
      insights: [
        {
          ...
          stance: "Test stance for: A novel insight",
      ...
      insights: [
        {
          ...
          topic: "testing",
          title: "Insight one",
          stance: "Test stance for: Insight one",
          actionability: "immediate",
          confidence: "high",
          shelf_life: "evergreen",
          tags: ["test"],
        ...
        },
        {
          ...
          topic: "testing",
          title: "Insight two",
          stance: "Test stance for: Insight two",
          actionability: "reference",
          confidence: "medium",
          shelf_life: "evergreen",
          tags: ["test"],
      ...
      insights: [
        {
          ...
          topic: "automation",
          title: "Only automate what you deeply understand",
          stance: "Test stance for: Only automate what you deeply understand",
          actionability: "immediate",
          confidence: "high",
          shelf_life: "evergreen",
          tags: ["automation", "understanding", "ai-agents"],
        ...
        },
        {
          ...
          stance: "Test stance for: Convert customers into employees",
          actionability: "reference",
          confidence: "medium",
          shelf_life: "evergreen",
      ...
      insights: [
        {
          ...
          stance: "Test stance for: Same title for uniqueness test",
          actionability: "immediate",
          confidence: "high",
          shelf_life: "evergreen",
          tags: ["test"],
