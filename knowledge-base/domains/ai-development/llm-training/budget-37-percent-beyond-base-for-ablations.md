...
status: active
tags: [llm, training, budget, ablations, compute-cost, huggingface]
sources:
  - type: reddit
...
resolutions:
  one_line: "Main pretraining consumes 63% of total compute; plan for 37% additional budget for ablation studies, debugging, and restarts due to infrastructure failures."
  standard: |
