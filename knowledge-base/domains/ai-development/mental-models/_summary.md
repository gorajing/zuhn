...
- `INS-260627-0127` [high] You don't need to translate every possible Python function — only the base set of elementary operations, because all variety is composition and permutation of that small set.
