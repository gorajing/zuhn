...
| architecture | 11 | Libraries are reusable because they are language, not because they are object-oriented. |
...
| platform-dynamics | 21 | OpenAI doesn't treat agents as a separate category — ChatGPT, Codex CLI, Sora, and the API are all just different interfaces for deploying the same underlying intelligence, each optimized for different user contexts. |
