...
- `INS-260626-D9EA` [high] AI-enabled individuals matched traditional human teams on average quality, so some teamwork benefits can be substituted before teams are redesigned.
...
- `INS-260530-8DE3` [high] Abhije (Google AI PM): 'Individually all of us are doing 10x better, but the team itself, we don't want to do 10x better.' AI gives individuals capacity their organizations cannot absorb.
...
- `INS-260605-9527` [medium] The weaver's-hands bottleneck moves from writing code to taste and orchestration; the hard question becomes who to say no to, not how to say yes.
...
- `INS-260627-F934` [medium] When every idea is a prompt away, the bottleneck shifts to choosing boundaries and refusing features — the integration of many ideas, not any single one, is what breaks systems.
...
- `INS-260627-1297` [medium] Empower support to ship fixes with AI codegen — they hold three structural advantages engineers lack, and it doubles as an engineering pipeline.
