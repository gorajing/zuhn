...
> 2020 insights across 20 topics
...
| cognitive-biases | 268 | Over 85% of near-Earth asteroids are found in the 45-degree band opposite the sun because asteroids approaching from the sun's direction are invisible to ground telescopes — no amount of better ground telescopes fixes this. |
| communication | 36 | Viewing argument as instinct rather than trainable craft creates a vicious cycle: bad arguments reduce confidence in disagreement, which further degrades argument quality. |
...
| decision-making | 86 | Judge purchases by projected usage, not by the deal you got. |
...
| learning | 255 | Twenty hours of focused study on a single skill creates enough baseline competence to unlock meaningfully better job opportunities. |
...
| persuasion | 62 | Credibility in political discourse requires praising opponents when warranted, not just criticizing allies — a rare and costly signal. |
