...
> 1655 insights across 20 topics
...
| communication | 15 | Viewing argument as instinct rather than trainable craft creates a vicious cycle: bad arguments reduce confidence in disagreement, which further degrades argument quality. |
...
| expertise | 28 | Having an audience prevents the natural tendency to stop thinking at exactly the point where deeper exploration would be most valuable. |
...
| group-dynamics | 32 | The Pueblo Revolt shows that a shared existential threat can override deep tribal divisions — but the unity is temporary. |
| learning | 215 | Twenty hours of focused study on a single skill creates enough baseline competence to unlock meaningfully better job opportunities. |
