...
> 2371 insights across 24 topics
...
| decision-making | 155 | If something powerful enough would leave unmistakable traces and you find none, that silence is itself a strong signal. |
| epistemics | 62 | Galef argues accurate maps of the world should include explicit uncertainty markers and remain provisional — 'drawn in pencil, not pen' — because false precision creates psychological resistance to updating when better evidence arrives. |
...
| group-dynamics | 107 | The Pueblo Revolt shows that a shared existential threat can override deep tribal divisions — but the unity is temporary. |
...
| learning | 244 | Twenty hours of focused study on a single skill creates enough baseline competence to unlock meaningfully better job opportunities. |
...
| mental-models | 99 | Computers are fully explainable bottom-up from electricity through logic gates to instructions — there is no magical layer, only layers of abstraction humans haven't personally traversed. |
...
| physics-intuition | 87 | Light's regularity means its full 3D state is determined by its values on any 2D boundary surface. |
