...
> 2331 insights across 24 topics

## Topics

| Topic | Insights | Preview |
| ----- | -------- | ------- |
| behavior-change | 39 | Rules-based approaches to distraction fail because the addictive part of your brain finds plausible exceptions; adversarial design works better. |
...
| cognitive-biases | 320 | Over 85% of near-Earth asteroids are found in the 45-degree band opposite the sun because asteroids approaching from the sun's direction are invisible to ground telescopes — no amount of better ground telescopes fixes this. |
...
| decision-making | 146 | Admitting you're bad at something is the first step to finding effective workarounds like delegation or systematic search. |
| epistemics | 54 | Galef argues accurate maps of the world should include explicit uncertainty markers and remain provisional — 'drawn in pencil, not pen' — because false precision creates psychological resistance to updating when better evidence arrives. |
...
| group-dynamics | 103 | The Pueblo Revolt shows that a shared existential threat can override deep tribal divisions — but the unity is temporary. |
...
| learning | 242 | Twenty hours of focused study on a single skill creates enough baseline competence to unlock meaningfully better job opportunities. |
...
| mental-models | 94 | Computers are fully explainable bottom-up from electricity through logic gates to instructions — there is no magical layer, only layers of abstraction humans haven't personally traversed. |
