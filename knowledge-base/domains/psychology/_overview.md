...
> 2071 insights across 20 topics
...
| cognition | 79 | Flat Earth theories are clever ad hoc explanations that address individual challenges but fail to fit all evidence into a unified framework. |
...
| decision-making | 95 | Admitting you're bad at something is the first step to finding effective workarounds like delegation or systematic search. |
...
| persuasion | 75 | Credibility in political discourse requires praising opponents when warranted, not just criticizing allies — a rare and costly signal. |
