...
> 1691 insights across 20 topics
...
| cognitive-biases | 225 | Over 85% of near-Earth asteroids are found in the 45-degree band opposite the sun because asteroids approaching from the sun's direction are invisible to ground telescopes — no amount of better ground telescopes fixes this. |
...
| decision-making | 46 | What looks like a flaw mid-process (arrow flexing wildly) is often the exact mechanism enabling the correct result. |
...
| group-dynamics | 35 | The Pueblo Revolt shows that a shared existential threat can override deep tribal divisions — but the unity is temporary. |
