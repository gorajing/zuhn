...
> 2474 insights across 24 topics
...
| cognitive-biases | 336 | Over 85% of near-Earth asteroids are found in the 45-degree band opposite the sun because asteroids approaching from the sun's direction are invisible to ground telescopes — no amount of better ground telescopes fixes this. |
...
| decision-making | 177 | If something powerful enough would leave unmistakable traces and you find none, that silence is itself a strong signal. |
...
| group-dynamics | 120 | The Pueblo Revolt shows that a shared existential threat can override deep tribal divisions — but the unity is temporary. |
...
| persuasion | 66 | Steady accumulation of documented incidents shifts opinion more than any single dramatic event because patterns resist counter-narrative. |
...
| resilience | 182 | Start documenting purposefully at your lowest point — that's when commitment crystallizes and the 'never again' story begins. |
