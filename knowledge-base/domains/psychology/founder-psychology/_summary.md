...
- `INS-260329-577E` [medium] When money arrives faster than feels normal, it indicates a large value gap has been identified — the correct response is to scale, not to question legitimacy.
- `INS-260330-669C` [medium] Ponzi's family decline from wealthy merchants to working class created a status-obsessed identity that made him reject honest work and pursue increasingly risky schemes.
- `INS-260405-DC20` [medium] Focus on how fast the work is improving, not where it currently stands.
