...
topic: biohacking
title: >-
  Upper cross syndrome from screen use is correctable within minutes through
...
resolutions:
  one_line: >-
    ...
    specific muscle activation patterns
  standard: >-
    Forward head posture and rounded shoulders from screen use (upper cross
    syndrome) can be rapidly corrected by activating weakened deep neck flexors
