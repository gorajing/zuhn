...
- `INS-260412-7BD5` [high] Li-Fi was demonstrated in a TED talk in 2011, reached real-world trials by 2015, yet still hasn't achieved mass adoption by 2026 — a pattern typical of physical-layer technologies.
...
- `INS-260410-E3E6` [high] NVIDIA's superpower is navigating to 'zero-billion-dollar markets' — non-existent markets they believe will emerge — and arriving a decade before competitors even understand why they're there.
...
- `INS-260412-E07F` [high] The Boeing 757 found its most valuable use case (transatlantic flights) 24 years after launch when twin-engine ocean regulations changed.
...
- `INS-260410-020E` [high] Qualcomm patented CDMA in 1986 when the processing required was physically impossible — because they correctly forecasted Moore's Law would make it feasible by ship date.
...
- `INS-260410-F38A` [high] Joe Coulombe read two articles — the GI Bill pushing college attendance from 2% to 60%, and the 747 cutting European travel cost 15x — and built an entire grocery chain around 'overeducated and underpaid' customers who didn't fully exist yet.
...
- `INS-260412-0D71` [medium] Graphene took 16 years from discovery (2004) to first consumer product (2020), consistent with historical timelines for carbon fiber, lithium-ion, and other breakthrough materials.
...
- `INS-260403-B835` [medium] Young founders use the latest technology first, positioning them to discover fixable brokenness before older, more experienced operators.
