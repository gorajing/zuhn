...
> 4580 insights across 55 topics
...
| business-models | 242 | The time required to build a company is often predictive of how long it will last. |
...
| company-culture | 8 | Rentech's location in East Setauket — a wooded Long Island town of 10,000 — is a load-bearing cultural feature, not an accident: employees don't grab drinks with Two Sigma counterparts because those counterparts aren't within reach. |
...
| competitive-strategy | 607 | 3D portfolio websites signal elite skill to non-technical evaluators while requiring only beginner-level Three.js knowledge. |
...
| disruption | 19 | When AI agents do the work instead of human seats, per-seat SaaS revenue evaporates. |
...
| execution | 292 | Doing 10-100x more volume beats 2x optimization, but you must relearn this lesson independently in each new domain you enter. |
...
| founder-psychology | 82 | Systrom tolerated years of small Facebook interferences but resigned when Zuckerberg throttled team growth and began treating Instagram as subordinate to Facebook's interests. |
| fundraising | 464 | Startups with 18+ months of runway are 3x more likely to secure follow-on funding because runway signals discipline and reduces investor risk perception. |
| growth | 112 | When an AI product cuts process time by 92%, the switching cost of NOT adopting it exceeds the cost of change, driving organic product-led growth. |
| growth-marketing | 151 | Channels with 3,000-5,000 subscribers are hitting 2-3 million views by applying proven formats to underserved markets — subscriber count doesn't determine reach when format-market fit is strong. |
...
| innovation | 136 | C invented the curly-brace, semicolon syntax that now defines how billions of developers write code — its design choices became the assumed defaults of most successor languages. |
...
| operations | 25 | The US government's COGCON system splits every agency into three independent teams (A, B, C) at separate sites, each ready to assume full operations if the team above it falls. |
...
| product | 24 | Treating aid recipients as product users with real feedback loops produces dramatically better outcomes than top-down charity models. |
...
| product-strategy | 91 | Juicero raised $120M for technology that was immediately undermined when customers realized the same outcome was achievable by hand. |
...
| scaling | 195 | Startups need 2-3x longer than founders expect to validate their market, and 70% scale prematurely — largely explaining the 90% failure rate. |
...
| timing | 68 | Enterprise SaaS IPOs from 2012 outperformed expectations by solving deep operational pain points with recurring revenue models. |
