...
> 2258 insights across 31 topics
...
| co-founders | 37 | Esther Perel's framework from couples therapy identifies three root causes under every co-founder conflict: who has power, who feels cared for, and who gets recognized. |
...
| execution | 172 | Doing 10-100x more volume beats 2x optimization, but you must relearn this lesson independently in each new domain you enter. |
| founder-mindset | 271 | During a crisis, the false but simple narrative ('Robinhood colluded with hedge funds') will always defeat the true but complex explanation (clearing mechanics, Dodd-Frank, collateral requirements). |
...
| fundraising | 56 | Raising $20M and selling for $30M nets the founder less money over 10 years than a regular salary — bootstrap instead. |
...
| ideation | 49 | The smartest people can make the impossible happen, but if you cannot attract the smartest people, you cannot even make the possible happen. |
| leadership | 148 | Formal raise processes protect culture; ad-hoc raises create a company where everyone feels obligated to lobby constantly. |
| market-entry | 9 | IBM's fatal error was granting a non-exclusive DOS license, allowing Microsoft to own the PC standard from within the supply chain. |
...
| product-development | 117 | Apple's 48-hour design review rhythm forced constant refinement that produced best-in-class products. |
