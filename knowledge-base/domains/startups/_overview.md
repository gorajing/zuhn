...
> 4643 insights across 55 topics
...
| company-culture | 11 | Neumann's personal habits — tequila retreats, barefoot offices, impulsive bans — became WeWork's culture, making the company inseparable from his increasingly erratic behavior. |
...
| competitive-strategy | 621 | 3D portfolio websites signal elite skill to non-technical evaluators while requiring only beginner-level Three.js knowledge. |
...
| market-entry | 59 | Simultaneous supply aging and demand shifting creates opportunities that favor operationally heavy startups over pure software. |
| marketing | 9 | Availability friction raises perceived value; waiting lists create the FOMO that 'buy now' buttons destroy. |
...
| product-strategy | 93 | Juicero raised $120M for technology that was immediately undermined when customers realized the same outcome was achievable by hand. |
