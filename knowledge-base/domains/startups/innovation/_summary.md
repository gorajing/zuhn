...
- `INS-260412-326A` [high] Bitcoin didn't invent digital currency — it solved the double-spending problem that killed eCash, b-money, and bit gold before it.
...
- `INS-260626-7DF1` [high] Every new tech starts by doing the old thing but more (more spreadsheets, more email); the important shift is the new thing you couldn't do before.
...
- `INS-260412-B825` [medium] Apple ran two competing iPhone teams (iPod-phone vs touch-Mac-OS) without letting them see each other's work, and the underdog team won.
...
- `INS-260627-A944` [medium] Something like OpenClaw 'would not have come out of an American company — it would have been killed in legal long before release'; permissionless personal risk-taking unlocks categories corporate compliance forbids.
