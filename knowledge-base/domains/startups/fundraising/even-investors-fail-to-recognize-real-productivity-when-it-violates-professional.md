...
topic: fundraising
title: >-
  Even investors fail to recognize real productivity when it violates
  professional norms
...
resolutions:
  one_line: >-
    Investors — supposedly experts at recognizing productive companies — are
    just as susceptible to mistaking professional appearance for real output.
  standard: >-
    Graham notes that even investors, whose entire job is to identify productive
    teams, couldn't recognize real productivity when it didn't match
    professional norms. This is a damning indictment of pattern-matching in
    venture capital: the patterns VCs match against are drawn from what
    successful companies look like at scale, not what they looked like when they
    were actually at peak productivity. The visibility problem compounds this —
    only 3-4 people witness the most productive phase of a startup, while tens
    of thousands see Boeing's version of business. This creates a systematic
    bias in capital allocation toward teams that look the part over teams doing
    the work.
stance: >-
