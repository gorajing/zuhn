...
topic: fundraising
title: >-
  Multi-round dilution modeling prevents founders from optimizing one raise at
  the expense of long-term ownership
...
resolutions:
  one_line: >-
    ...
    that erodes founder ownership far more than single-round analysis suggests.
  standard: >-
    The most common founder mistake is optimizing valuation for the current
    round without modeling the cumulative effect across seed, Series A, B, and
    C. A seemingly favorable $20M post-money valuation at seed becomes
    devastating if subsequent rounds require heavy dilution. Each round
    compounds: ESOP pools expand, anti-dilution provisions trigger, and early
    investor protections layer.


    The fix is running a multi-round ownership waterfall before every raise.
    This means modeling not just 'how much equity am I giving up now?' but 'what
    does my ownership look like at a $200M exit after four rounds of financing?'
    Founders who do this math negotiate differently—they may accept a lower
    valuation today to preserve better terms that protect downstream ownership.
stance: >-
...
The fix is running a multi-round ownership waterfall before every raise. This means modeling not just 'how much equity am I giving up now?' but 'what does my ownership look like at a $200M exit after four rounds of financing?' Founders who do this math negotiate differently—they may accept a lower valuation today to preserve better terms that protect downstream ownership.
