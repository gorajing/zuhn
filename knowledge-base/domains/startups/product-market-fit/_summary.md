...
- `INS-260626-D91F` [high] Find what users are already doing (often hacking around your product) and make that easier — don't try to introduce new behavior.
...
- `INS-260409-4EC0` [medium] Early-stage churn is an education problem, not a product problem — fix it with your time, not a roadmap.
- `INS-260405-0E05` [medium] In early stage, the depth of user love is a better signal than any metric you can count.
- `INS-260405-C5B4` [medium] GOAT's $4B valuation traces back to authenticating sneakers, not selling them.
- `INS-260405-474C` [medium] ChatGPT's capabilities set the expectation ceiling for every AI product, regardless of use case.
