...
status: active
tags: [n8n, multi-agent, ai-pipeline, firecrawl, perplexity, gemini, workflow-patterns]
sources:
  - type: reddit
...
resolutions:
  one_line: "Chain specialized AI agents in n8n -- scraper (Firecrawl) feeds analyst (Perplexity) feeds formatter (Gemini) -- each agent does one job well, keeping the pipeline modular and cheap."
  standard: |
