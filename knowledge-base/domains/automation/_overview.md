...
| n8n-workflows | 11 | Full pipeline: search query to scrape 100+ profiles, extract data, pull company info, AI-generate personalized opener, export to Google Sheets. |
| pipelines | 18 | Maja Voje (The GTM Strategist): a team still prompting is running a chatbot; a team doing context engineering is running a brain. |
| robotics | 17 | Shipping robots unassembled and fully repairable at hacker prices is a deliberate strategy to keep the robotic future from being owned by one company. |
...
| workflow-design | 3 | Do not accept agent-infra savings unless task correctness survives the optimization. |
