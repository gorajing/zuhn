...
- `INS-260627-3133` The high-value deep-research use cases all share a shape: produce a long structured document by gathering and synthesizing answers spread across many internal sources.
